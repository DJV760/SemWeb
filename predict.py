...
test_image_paths, test_label_map_paths = get_dataset_slice_paths('C:\\Users\\z0224841\\PycharmProjects\\SemWeb\\test_data\\test_img', 'C:\\Users\\z0224841\\PycharmProjects\\SemWeb\\test_data\\test_mask')
...
results = model.predict(test_dataset, steps=validation_steps)
...
# input a number from 0 to 67 to pick an image from the test set
integer_slider = 22
